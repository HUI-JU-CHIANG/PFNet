...
ckpt_path = 'D:/Olia/結構化機器學習/CVPR2021_PFNet-main/ckpt'
exp_name = 'PFNet'
...
log_path = os.path.join(ckpt_path, exp_name, f"{log_time}.txt")
...
def main():
    ...
    net = PFNet(backbone_path).to(device).train()
    ...
    net = nn.DataParallel(net, device_ids=device_ids) if device_ids else net
